...
public class DeleteUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Enter name and id of user");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try 
        ...
        String Query ="DELETE FROM USER1 WHERE NAME = '"+nameText.getText()+"' AND ID='"+idText.getText()+"'";      
        stmt.execute(Query);
        
        JOptionPane.showMessageDialog(null, "The user"+nameText.getText() +" is Deleted succesfully.");
